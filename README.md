...
Este es un script de auto instalación que recopila las herramientas que utilizo
habitualmente en distribuciones Linux basadas en Debian.
Aunque las herramientas están pensadas para mi flujo de trabajo personal,
este script sirve como una base de partida para que otros usuarios puedan:
